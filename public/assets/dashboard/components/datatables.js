			...
			columnDefsVar.push({
				...
				render: function(data, type, full, meta) {
					...
					if($('input[name="data-vws"]').val() == 1){
						showButton = '<a data-toggle="tooltip" data-original-title="'+showText+'" href="/'+designElems.mainData.url+'/view/'+data+'" class="mx-1 action-icon btn btn-sm btn-info btn-icon"> <i class="icon-xl la la-eye"></i></a>'
					}
