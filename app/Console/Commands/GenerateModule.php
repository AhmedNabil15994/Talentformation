...
class GenerateModule extends Command {
    ...
    public function handle() {
        ...
        $eloquentRepoStub = str_replace(
            ['{{namespace}}', '{{modelName}}','{{uploadFolder}}'],
            ['App\\Repositories', $modelName , lcfirst($modelPlural)],
            $eloquentRepoStub
        );
        ...
        $controllerStub = str_replace(
            ['{{namespace}}', '{{moduleName}}', '{{modelName}}','{{modelNameLower}}', '{{modelNamePlural}}' , '{{modelPlural}}' , '{{requestPath}}' , '{{uploadFolder}}','{{indexURL}}'],
            [
                'App\\Http\\Controllers', $moduleName, $modelName , lcfirst($modelName), $modelPlural,$modelPlural , 
                'App\\Http\\Requests\\'.$modelName.'Validator',lcfirst($modelPlural), "'/".$basePrefix."/".lcfirst($modelPlural)."'"
            ],
            $controllerStub
        );
