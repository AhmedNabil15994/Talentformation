<div class="form-group p-0 m-0 mb-5">
    <label class="col-form-label">{{ trans('Dashboard::dashboard.setting.app_white_logo') }}</label>
    <div class="col-12 p-0">
        <div class="image-input image-input-empty image-input-outline" id="kt_image_5" style="background-image: url({{ asset( (isset($data['app_white_logo']) && !empty($data['app_white_logo']) ? $data['app_white_logo'] : 'assets/dashboard/images/logo.png') )  }})">
            ...
            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="{{trans('User::user.form.change_image_p')}}">
                ...
                <input type="file" name="app_white_logo"/>
                <input type="hidden" name="app_white_logo_remove"/>
            </label>

            @if(isset($data['app_white_logo']) && !empty($data['app_white_logo']))
            <div class="my-gallery" itemscope="" itemtype="" data-pswp-uid="1">
               <figure itemprop="associatedMedia" itemscope="" itemtype="">
                    <a href="{{ $data['app_white_logo'] }}" itemprop="contentUrl" data-size="555x370"><i class="fa fa-search"></i></a>
                    <img src="{{ $data['app_white_logo'] }}" itemprop="thumbnail" style="display: none;">
                </figure>
            </div>
            @endif
...
<div class="form-group p-0 m-0 mb-5">
    <label class="col-form-label">{{ trans('Dashboard::dashboard.setting.app_dark_logo') }}</label>
    <div class="col-12 p-0">
        <div class="image-input image-input-empty image-input-outline" id="kt_image_8" style="background-image: url({{ asset( (isset($data['app_dark_logo']) && !empty($data['app_dark_logo']) ? $data['app_dark_logo'] : 'assets/dashboard/images/logo.png') )  }})">
            <div class="image-input-wrapper"></div>
            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="{{trans('User::user.form.change_image_p')}}">
                <i class="fa fa-pen icon-sm text-muted"></i>
                <input type="file" name="app_dark_logo"/>
                <input type="hidden" name="app_dark_logo_remove"/>
            </label>

            @if(isset($data['app_dark_logo']) && !empty($data['app_dark_logo']))
            <div class="my-gallery" itemscope="" itemtype="" data-pswp-uid="1">
               <figure itemprop="associatedMedia" itemscope="" itemtype="">
                    <a href="{{ $data['app_dark_logo'] }}" itemprop="contentUrl" data-size="555x370"><i class="fa fa-search"></i></a>
                    <img src="{{ $data['app_dark_logo'] }}" itemprop="thumbnail" style="display: none;">
                </figure>
            </div>
            @endif
...
<div class="form-group row p-0 m-0 mb-5">
    <label class="col-form-label">{{ trans('Dashboard::dashboard.setting.company_profile') }}</label>
    <div class="col-12 p-0">
        <div class="image-input image-input-empty image-input-outline" id="kt_image_9" style="background-image: url({{ asset( (isset($data['company_profile']) && !empty($data['company_profile']) ? $data['company_profile'] : 'assets/dashboard/images/logo.png') )  }})">
            <div class="image-input-wrapper"></div>
            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="">
                ...
                <input type="hidden" name="company_profile_remove"/>
            </label>

            @if(isset($data['company_profile']) && !empty($data['company_profile']))
            <div class="my-gallery" itemscope="" itemtype="" data-pswp-uid="1">
               <figure itemprop="associatedMedia" itemscope="" itemtype="">
                    <a href="{{ $data['company_profile'] }}" itemprop="contentUrl" data-size="555x370"><i class="fa fa-search"></i></a>
                    <img src="{{ $data['company_profile'] }}" itemprop="thumbnail" style="display: none;">
                </figure>
            </div>
            @endif
