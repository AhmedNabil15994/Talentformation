...
<div class="form-group p-0 m-0 mb-5">
    <label for="inputEmail3">{{ trans('Dashboard::dashboard.setting.calendly_url') }} :</label>
    <input type="text" class="form-control col-md-8" name="calendly_url" value="{{ isset($data['calendly_url']) && !empty($data['calendly_url']) ? $data['calendly_url'] : old('calendly_url') }}" placeholder="{{ trans('Dashboard::dashboard.setting.calendly_url') }}">
</div>
