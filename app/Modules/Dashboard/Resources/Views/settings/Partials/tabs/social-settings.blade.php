...
<div id="kt_repeater_2">
    <div class="form-group p-0 m-0 mb-5">
        ...
        <div data-repeater-list="socials" class="col-lg-8">
            ...
            <div data-repeater-item="" class="mb-2">
                <div class="row">
                    ...
                    <div class="input-group col-6">
                        ...
                        <input type="text" name="icon" value="{{$platform['icon'] ?? ''}}" class="form-control" placeholder="{{trans('Dashboard::dashboard.icon')}}">
