    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >{{trans('Page::page.newOne')}}</h5>
                ...
                <div class="active show" role="tabpanel">
                    <ul class="nav nav-tabs nav-primary nav-tabs-space-lg nav-tabs-bold" role="tablist">
                        ...
                        <li class="nav-item mx-2">
                            <a class="nav-link {{$key == 0 ? 'active' : ''}}" id="page-tab-{{$key+1}}" data-toggle="tab" href="#page-{{$key+1}}">
                    ...
                    <div class="tab-content mt-5" id="typeTabContent">
                        @foreach($available_locales as $key => $lang)
                        <div class="tab-pane fade {{$key == 0 ? 'active show' : '' }}" id="page-{{$key+1}}" role="tabpanel" aria-labelledby="page-tab-{{$key+1}}">
