...
{   
    ...
    public function searchData(): array
    {
        return  [
            'category_id' => [
                ...
                'class' => 'form-control datatable-input',
                'index' => '3',
                'label' => trans('Service::service.form.category'),
                'options' => \App\Entities\Category::where([['status',1],['id','!=',1]])->get(['id',"name_".LANGUAGE_PREF." as title"]),
            ],
        ];
    }
    ...
    public function tableData()
    {
        return [
            ...
            'views' => [
                'label' => trans('Service::service.form.views'),
                'type' => '',
                'className' => '',
                'data-col' => 'views',
                'anchor-class' => '',
