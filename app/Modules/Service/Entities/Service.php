...
class Service extends Model {
    ...
    protected $fillable = ['title_ar','title_en','description_ar','description_en','metadata','image','category_id','status','views','sort','created_at','updated_at','deleted_at',];
    ...
    public function getImageUrlAttribute(){
        return \FilesHelper::getImagePath('services',$this->id,$this->image,true);
    }
