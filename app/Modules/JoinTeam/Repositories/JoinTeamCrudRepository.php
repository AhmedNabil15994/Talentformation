...
class JoinTeamCrudRepository implements DesignInterface
{   
    ...
    {
        return [
            'title' => trans('JoinTeam::joinTeam.title'),
            'url' => 'dashboard/'.'joinTeams',
            'name' => 'join-teams',
            'nameOne' => 'join-team',
            'modelName' => 'JoinTeam',
            'icon' => ' fas fa-envelope-open-text',
            'sortName' => '',
            'addOne' => trans('JoinTeam::joinTeam.newOne'),
        ];
    }
    ...
    public function searchData(): array
    {
        return  [
            'name' => [
                ...
                'index' => '1',
                'label' => trans('JoinTeam::joinTeam.form.name'),
            ],
            'email' => [
                'type' => 'text',
                'class' => 'form-control datatable-input',
                'index' => '2',
                'label' => trans('JoinTeam::joinTeam.form.email'),
            ],
            'phone' => [
                'type' => 'text',
                'class' => 'form-control datatable-input',
                'index' => '2',
                'label' => trans('JoinTeam::joinTeam.form.phone'),
            ],
            'designation' => [
                'type' => 'text',
                'class' => 'form-control datatable-input',
                'index' => '2',
                'label' => trans('JoinTeam::joinTeam.form.designation'),
            ],
            'date' => [
                'type' => 'text',
